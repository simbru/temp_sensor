...
data_cache = {
    ...
    # Streaming support: track how many new points arrived
    "new_point_count": 0,  # 0 = no change, >0 = incremental, -1 = full refresh needed
    "log_interval_s": None,
}
...
def fetch_initial_data(sensor_name):
    ...
    try:
        ...
        data_cache["new_point_count"] = -1  # Full refresh needed
